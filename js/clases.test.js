...
test('Registrar Reserva con datos validos', () => {
  ...
  sistema.registrarReserva('Juan', 'Pérez', 'jp@mail.com', '099123456', 'Carlos', servicios, '2025-08-01T14:00');
...
test('Registrar Servicio con datos validos', () => {
  const sistema = new Sistema();
  sistema.registrarServicio('Afeitado', 500, '30min');
...
test('Crear Reserva con datos validos', () => {
  const reserva = new Reserva('Ana', 'López', 'ana@mail.com', '098765432', 'Carlos', ['Corte'], new Date());
...
test('Registrar Reserva Precargarda en localStorage si está vacío', () => {
  ...
  sistema.registrarReservaPre('Ana', 'López', 'ana@mail.com', '099999999', 'Carlos', servicios, '2025-08-01T14:00');
...
test('Obtener Servicios', () => {
  const sistema = new Sistema();
  sistema.registrarServicio('Corte', 400, '30min');
  sistema.registrarServicio('Afeitado', 300, '20min');
...
test('Obtener Reservas', () => {
  const sistema = new Sistema();
  sistema.registrarReservaPre('Ana', 'López', 'ana@mail.com', '099999999', 'Carlos', ['Corte'], '2025-08-01T14:00');
...
test('Debería lanzar un error si el nombre o apellido están vacíos', () => {
        expect(() => {
            const sistema = new Sistema();
            sistema.registrarReserva('', 'Perez', 'email@test.com', '123456789', 'Barbero A', ['Corte'], '2025-08-01');
        }).toThrow('El nombre o apellido no pueden ser vacios');

        expect(() => {
            const sistema = new Sistema();
            sistema.registrarReserva('Juan', '', 'email@test.com', '123456789', 'Barbero A', ['Corte'], '2025-08-01');
        }).toThrow('El nombre o apellido no pueden ser vacios');
    });
    ...
    test('Debería lanzar un error si el email no contiene un arroba', () => {
        expect(() => {
            const sistema = new Sistema();
            sistema.registrarReserva('Juan', 'Perez', 'email.test.com', '123456789', 'Barbero A', ['Corte'], '2025-08-01');
    ...
    test('Debería lanzar un error si el teléfono no tiene 9 dígitos', () => {
        expect(() => {
            const sistema = new Sistema();
            sistema.registrarReserva('Juan', 'Perez', 'email@test.com', '12345', 'Barbero A', ['Corte'], '2025-08-01');
    ...
    test('Debería lanzar un error si el barbero está vacío', () => {
        expect(() => {
            const sistema = new Sistema();
            sistema.registrarReserva('Juan', 'Perez', 'email@test.com', '123456789', '', ['Corte'], '2025-08-01');
    ...
    test('Debería lanzar un error si la lista de servicios está vacía', () => {
        expect(() => {
            const sistema = new Sistema();
            sistema.registrarReserva('Juan', 'Perez', 'email@test.com', '123456789', 'Barbero A', [], '2025-08-01');
    ...
    test('Debería lanzar un error si la fecha está vacía', () => {
        expect(() => {
            const sistema = new Sistema();
            sistema.registrarReserva('Juan', 'Perez', 'email@test.com', '123456789', 'Barbero A', ['Corte'], '');
